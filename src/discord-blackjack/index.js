/* eslint-disable */
// WRITTEN BY https://github.com/3061LRTAGSPKJMORMRT
// THIS IS MODIFIED TO WORK WITHIN THIS PROJECT.
// BY THAT I MEAN I TOOK OUT THEIR STUPID ASS INSTANCE CHECKS
// CAUSE ITS OUTDATED.
...
module.exports = async (message, options) =>
{
    ...
    {
        commandType = "message"
    } else if (message instanceof Discord.CommandInteraction || message instanceof Discord.ChatInputCommandInteraction)
    {
